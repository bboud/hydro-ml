...
class Discriminator(nn.Module):
    def __init__(self, ndf):
        ...
        self.discrim = nn.Sequential(
            ...
            self._block(1, (ndf // 16), 4, 2, 2, 1),

            #Shape: ndf//16 x 64
            self._block((ndf // 16), (ndf // 8), 4, 2, 2, 1),

            # Shape: ndf//8 x 32
            self._block((ndf // 8), (ndf // 4), 4, 2, 2, 1),

            # Shape: ndf//4 x 16
            self._block((ndf // 4), (ndf // 2), 4, 2, 2, 1),

            # Shape: ndf//2 x 8
            self._block((ndf // 2), (ndf), 4, 2, 2, 1),
